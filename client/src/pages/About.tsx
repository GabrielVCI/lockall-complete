        ...
        <div className="container">
          <div className="text-center max-w-[720px] mx-auto">
            ...
            <p className="text-[17px] leading-relaxed text-lockall-graphite max-w-[600px] mx-auto">
              Una empresa multinacional dedicada a ofrecer soluciones de
              mitigación de riesgo para el sector financiero, respaldadas por
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <SectionReveal delay={200}>
              <div>
                <h2 className="font-display font-bold text-[clamp(2rem,4vw,2.5rem)] leading-[1.1] tracking-tight text-lockall-navy mb-6">
                  Infraestructura Global para la Protección de Activos
                  Financiados
                </h2>
                <p className="text-[16px] leading-relaxed text-lockall-graphite mb-5">
                  LOCKALL nació de la identificación de una necesidad real en el
                  mercado financiero: la falta de soluciones especializadas para
                  mitigar el riesgo en el financiamiento de dispositivos
                  tecnológicos. Lo que comenzó como una iniciativa enfocada se
                  ha convertido en una operación con presencia en más de 45
                  países.
                </p>
                <p className="text-[16px] leading-relaxed text-lockall-graphite mb-5">
                  A través de las soluciones que ofrecemos, se procesan millones
                  de transacciones diarias, proporcionando a bancos,
                  instituciones financieras y retailers las herramientas
                  necesarias para proteger sus carteras de financiamiento de
                  dispositivos de manera eficiente y conforme a la regulación
                  local.
                </p>
                <p className="text-[16px] leading-relaxed text-lockall-graphite">
                  Con equipos distribuidos en América Latina, Europa, Asia y
                  África, mantenemos una operación continua que combina
                  experiencia técnica con conocimiento regulatorio profundo en
                  cada mercado donde operamos.
                </p>
              </div>
            </SectionReveal>
          </div>
        ...
        <div className="container">
          <SectionReveal>
            <div className="text-center max-w-[680px] mx-auto mb-16">
              ...
              <p className="text-[16px] leading-relaxed text-lockall-graphite">
                Tres pilares que guían cada decisión operativa y estratégica de
                la organización.
              </p>
            </div>
          </SectionReveal>
      ...
      <section className="py-20 bg-lockall-navy">
        <div className="container text-center">
          <SectionReveal>
            ...
            <p className="text-[16px] text-white/60 max-w-[600px] mx-auto mb-8">
              Con oficinas regionales y equipos de cumplimiento dedicados en
              cada mercado, LOCKALL combina alcance global con conocimiento local
              para servir a instituciones financieras en todo el mundo.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-6 text-[14px] font-heading text-white/40">
              {[
                "América Latina",
