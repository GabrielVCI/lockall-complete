        ...
        <div className="container">
          <div className="text-center max-w-[720px] mx-auto">
            ...
            <p className="text-[17px] leading-relaxed text-lockall-graphite max-w-[600px] mx-auto">
              Un proceso estructurado en cuatro fases que garantiza una
              implementación eficiente y resultados medibles desde las primeras
      ...
      <section className="py-20 bg-lockall-cyan">
        <div className="container text-center">
          <SectionReveal>
            ...
            <p className="text-[16px] text-white/80 max-w-[520px] mx-auto mb-8">
              Nuestro equipo le guiará a través de cada fase, adaptando la
              implementación a las necesidades específicas de su institución.
            </p>
