...
const complianceItems = [
  {
    icon: Globe,
    title: "Regulación de telecomunicaciones",
    desc: "Cumplimiento con las normativas de telecomunicaciones aplicables en cada jurisdicción donde operamos.",
  },
  {
    icon: Scale,
    title: "Protección al consumidor",
    desc: "Diseño de procesos que respetan los derechos del consumidor con mecanismos transparentes.",
  },
  {
    icon: FileCheck,
    title: "Privacidad de datos",
    desc: "Adherencia a marcos internacionales incluyendo GDPR, LGPD y regulaciones locales.",
  },
  {
    icon: BookOpen,
    title: "Normativa financiera",
    desc: "Operación alineada con los requisitos regulatorios del sector financiero.",
  },
  {
    icon: ShieldCheck,
    title: "Certificaciones de seguridad",
    desc: "Procesos alineados con estándares internacionales incluyendo ISO 27001 y SOC 2 Type II.",
  },
  {
    icon: Users,
    title: "Equipos de cumplimiento locales",
    desc: "Profesionales dedicados en cada región trabajando con autoridades regulatorias.",
  },
];
        ...
        <div className="container">
          <div className="text-center max-w-[720px] mx-auto">
            ...
            <p className="text-[17px] leading-relaxed text-lockall-graphite max-w-[600px] mx-auto">
              La seguridad y el cumplimiento regulatorio son pilares fundamentales de nuestra operación. 
              Cada componente de las soluciones que ofrecemos ha sido diseñado con estos principios como requisitos no negociables.
            </p>
        ...
        <div className="container">
          ...
          <SectionReveal>
            <div className="text-center max-w-[680px] mx-auto mb-16">
              ...
              <p className="text-[16px] leading-relaxed text-lockall-graphite">
                Las soluciones de LOCKALL han sido diseñadas para cumplir con los estándares más exigentes del sector financiero. 
                Cada capa de protección opera de forma independiente, conformando una estrategia de defensa en profundidad.
              </p>
        ...
        <div className="container">
          ...
          <SectionReveal>
            <div className="text-center max-w-[680px] mx-auto mb-16">
              ...
              <p className="text-[16px] leading-relaxed text-lockall-graphite">
                Operamos bajo un marco de cumplimiento integral que abarca regulaciones de telecomunicaciones,
                protección al consumidor, privacidad de datos y normativa financiera en cada jurisdicción
          ...
          <SectionReveal>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-14">
              {["ISO 27001", "SOC 2 Type II", "GDPR", "LGPD", "PCI DSS", "FIPS 140-2"].map((std) => (
                <div key={std} className="flex items-center gap-2">
                  <CheckCircle2 size={14} className="text-lockall-cyan" />
                  <span className="text-[14px] font-heading font-medium text-white/70">
                    {std}
                  </span>
                </div>
              ))}
