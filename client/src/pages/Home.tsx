...
//   return (
//     <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden bg-lockall-navy">
//       {/* Video Background */}
...
//         {/* Overlays */}
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_center,rgba(14,165,233,0.12),transparent_28%)]" />
//         <div className="absolute inset-0 bg-gradient-to-b from-lockall-navy/60 via-lockall-navy/78 to-lockall-navy/92" />
//         <div className="absolute inset-0 bg-gradient-to-r from-lockall-navy/88 via-lockall-navy/72 to-lockall-navy/88" />
//       </div>
...
//           {/* Top trust pills */}
//           <div
//             className={`flex flex-wrap items-center justify-center gap-3 mb-8 transition-all duration-700 ease-out ${
//               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
//             }`}
//             style={{ transitionDelay: "200ms" }}
//           >
//             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-lockall-cyan/25 bg-lockall-cyan/10 backdrop-blur-sm">
//               <div className="w-1.5 h-1.5 rounded-full bg-lockall-cyan animate-pulse" />
//               <span className="text-[11px] font-heading font-semibold tracking-[0.18em] uppercase text-lockall-cyan">
//                 Infraestructura de Protección Financiera
//               </span>
//             </div>

//             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-white/70 text-[12px] font-heading">
//               <Shield size={14} className="text-lockall-cyan" />
//               Seguridad de nivel empresarial
//             </div>

//             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-white/70 text-[12px] font-heading">
//               <BarChart3 size={14} className="text-lockall-cyan" />
...
//           {/* Main headline */}
//           <h1
//             className={`mx-auto max-w-[980px] font-display font-bold text-[clamp(2.8rem,6vw,5.4rem)] leading-[0.95] tracking-tight text-white mb-6 transition-all duration-1000 ease-out ${
//               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
//             }`}
//             style={{ transitionDelay: "350ms" }}
//           >
//             Proteja su cartera con{" "}
//             <span className="text-lockall-cyan">
//               mitigación de riesgo inteligente
//             </span>{" "}
//             para dispositivos financiados
//           </h1>

//           {/* Subtitle */}
//           <p
//             className={`mx-auto max-w-[820px] text-[17px] md:text-[19px] leading-relaxed text-white/68 mb-10 transition-all duration-1000 ease-out ${
//               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
//             style={{ transitionDelay: "550ms" }}
//           >
//             LOCKALL ayuda a instituciones financieras, retailers y programas de
//             crédito a proteger teléfonos móviles y electrodomésticos financiados
//             mediante una infraestructura tecnológica avanzada, segura y escalable.
//           </p>

//           {/* Support cards */}
//           <div
//             className={`grid grid-cols-1 md:grid-cols-3 gap-4 max-w-[980px] mx-auto mb-10 transition-all duration-1000 ease-out ${
//               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
//             style={{ transitionDelay: "700ms" }}
//           >
//             <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4 text-left">
//               <div className="text-[11px] font-heading uppercase tracking-[0.18em] text-lockall-cyan/80 mb-2">
//                 Protección
//               </div>
//               <p className="text-[14px] leading-relaxed text-white/72">
//                 Control de activos a nivel de dispositivo con ejecución segura y continua.
//               </p>
//             </div>
...
//               </div>
//               <p className="text-[14px] leading-relaxed text-white/72">
//                 Compatible con operaciones, modelos de cartera y procesos existentes.
//               </p>
//             </div>
...
//               </div>
//               <p className="text-[14px] leading-relaxed text-white/72">
//                 Diseñado para despliegues empresariales, entornos regulados y operación masiva.
//               </p>
//             </div>
//           </div>
...
//           {/* CTA row */}
//           <div
//             className={`flex flex-wrap items-center justify-center gap-4 mb-14 transition-all duration-1000 ease-out ${
//               loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
...
//             <Link
//               href="/contacto"
//               className="inline-flex items-center justify-center gap-2 h-12 px-7 text-[14px] font-heading font-semibold text-lockall-navy bg-lockall-cyan hover:bg-lockall-cyan-light rounded-md transition-all duration-200 shadow-[0_4px_20px_rgba(14,165,233,0.30)]"
//             >
...
//             <Link
//               href="/contacto"
//               className="inline-flex items-center justify-center gap-2 h-12 px-7 text-[14px] font-heading font-semibold text-white/90 border border-white/20 hover:border-white/40 hover:bg-white/5 rounded-md transition-all duration-200 backdrop-blur-sm"
//             >
...
//           >
//             <div className="grid grid-cols-1 sm:grid-cols-3 max-w-[760px] mx-auto overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md">
//               <div className="px-6 py-6 flex justify-center sm:justify-start">
//                 <MetricBlock
//                   value={45}
//                   suffix="+"
...
//               <div className="border-t sm:border-t-0 sm:border-l border-white/10 px-6 py-6 flex justify-center sm:justify-start">
//                 <MetricBlock
//                   value={12}
//                   suffix="M+"
...
//       <div
//         className={`text-[30px] font-heading font-bold leading-none ${
...
//       </div>
//       <div
//         className={`text-[12px] font-heading mt-2 tracking-wide ${
        ...
        <div className="max-w-[1100px] mx-auto text-center">
          ...
          >
            <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4 text-left">
              ...
              <p className="text-[14px] leading-relaxed text-white/72">
                Control de activos a nivel de dispositivo con ejecución segura y
                continua.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4 text-left">
              ...
              <p className="text-[14px] leading-relaxed text-white/72">
                Compatible con operaciones, modelos de cartera y procesos
                existentes.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4 text-left">
              ...
              <p className="text-[14px] leading-relaxed text-white/72">
                Diseñado para despliegues empresariales, entornos regulados y
                operación masiva.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SectionReveal>
            <div>
              ...
              <p className="text-[16px] leading-relaxed text-lockall-graphite mb-6">
                LOCKALL ofrece soluciones de mitigación de riesgo que operan a
                nivel de dispositivo, proporcionando a las instituciones
                financieras un mecanismo de protección sin precedentes sobre los
                activos tecnológicos que financian.
              </p>
              <p className="text-[16px] leading-relaxed text-lockall-graphite mb-8">
                Nuestras soluciones combinan seguridad a nivel de hardware,
                inteligencia de datos y cumplimiento regulatorio en una oferta
              ...
              <div className="p-5 bg-lockall-pearl rounded border border-border">
                <p className="text-[15px] font-heading font-semibold text-lockall-navy">
                  No somos un sistema. Somos el aliado estratégico que protege
                  su cartera de financiamiento.
                </p>
              </div>
          ...
          <SectionReveal>
            <div>
              ...
              <p className="text-[16px] leading-relaxed text-lockall-graphite mb-6">
                ...
                respaldadas por infraestructura distribuida que garantiza baja
                latencia y alta disponibilidad. Nos adaptamos a los marcos
                regulatorios de cada jurisdicción, asegurando cumplimiento
                normativo sin comprometer la eficiencia operativa.
              </p>
              <p className="text-[16px] leading-relaxed text-lockall-graphite mb-8">
                Cada despliegue regional cuenta con equipos de cumplimiento
                dedicados que trabajan en coordinación con las autoridades
    ...
    <section className="py-20 bg-lockall-cyan relative overflow-hidden">
      <div className="container relative z-10 text-center">
        <SectionReveal>
          ...
          <p className="text-[16px] text-white/80 max-w-[520px] mx-auto mb-8">
            Agende una demostración privada con nuestro equipo de especialistas
            y conozca cómo las soluciones de LOCKALL pueden integrarse con su
            operación.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
