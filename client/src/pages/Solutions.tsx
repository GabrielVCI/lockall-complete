      ...
      <div className="container">
        <div className="text-center max-w-[720px] mx-auto">
          ...
          <p className="text-[17px] leading-relaxed text-lockall-graphite max-w-[600px] mx-auto">
            Tres soluciones integradas que cubren el ciclo completo de protección
            de activos financiados: desde la prevención hasta la inteligencia
            predictiva.
          </p>
        </div>
      </div>
      ...
      <div className="container">
        <SectionReveal>
          <div className="text-center max-w-[680px] mx-auto mb-16">
            <span
              className={`text-[12px] font-heading font-semibold tracking-widest uppercase mb-4 block ${tagColor}`}
            >
              {tag}
            </span>
            <h2 className="font-display font-bold text-[clamp(2rem,4vw,2.75rem)] leading-[1.1] tracking-tight text-lockall-navy mb-3">
    ...
    <Layout>
      ...
      <ProductSection
        ...
        capabilities={[
          {
            icon: Shield,
            title: "Protección persistente",
            desc: "Mecanismo de protección que permanece activo incluso después de un restablecimiento de fábrica o cambio de SIM.",
          },
          {
            icon: Fingerprint,
            title: "Identificación única",
            desc: "Cada dispositivo recibe un identificador criptográfico único vinculado a la cuenta de financiamiento.",
          },
          {
            icon: Lock,
            title: "Bloqueo gradual",
            desc: "Sistema de restricciones progresivas que permite acciones proporcionales al estado de la cuenta.",
          },
          {
            icon: ServerCrash,
            title: "Resistencia a manipulación",
            desc: "Detección y respuesta ante intentos de evasión, incluyendo cambio de firmware y manipulación de software.",
          },
          {
            icon: Smartphone,
            title: "Compatibilidad amplia",
            desc: "Soporte para los principales sistemas operativos y fabricantes de dispositivos del mercado.",
          },
          {
            icon: Settings,
            title: "Configuración remota",
            desc: "Gestión centralizada de políticas de protección aplicables a toda la cartera de dispositivos.",
          },
        ]}
      />
        ...
        capabilities={[
          {
            ...
            desc: "Canal cifrado de comunicación bidireccional con cada dispositivo de la cartera.",
          },
          {
            icon: Zap,
            title: "Ejecución inmediata",
            desc: "Comandos de protección que se ejecutan en segundos, independientemente de la ubicación del dispositivo.",
          },
          {
            icon: Timer,
            title: "Automatización de políticas",
            desc: "Reglas configurables que ejecutan acciones automáticas basadas en el estado de la cuenta.",
          },
          {
            icon: ToggleRight,
            title: "Control granular",
            desc: "Capacidad de aplicar restricciones específicas por dispositivo, grupo o segmento de cartera.",
          },
          {
            icon: MessageSquare,
            title: "Notificaciones inteligentes",
            desc: "Sistema de alertas al usuario final con mensajes personalizables según la etapa de gestión.",
          },
          {
            icon: Settings,
            title: "Integración API",
            desc: "API RESTful documentada para integración directa con sistemas de gestión de cartera existentes.",
          },
        ]}
        reversed
      />
        ...
        capabilities={[
          {
            ...
            desc: "Visualización en tiempo real del estado de la cartera con métricas clave de rendimiento y riesgo.",
          },
          {
            icon: TrendingUp,
            title: "Predicción de riesgo",
            desc: "Modelos predictivos que identifican cuentas con alta probabilidad de incumplimiento antes de que ocurra.",
          },
          {
            icon: PieChart,
            title: "Segmentación avanzada",
            desc: "Análisis de cartera por múltiples dimensiones: geografía, tipo de dispositivo, perfil de riesgo.",
          },
          {
            icon: AlertTriangle,
            title: "Alertas tempranas",
            desc: "Sistema de detección temprana de patrones anómalos que pueden indicar fraude o evasión.",
          },
          {
            icon: TrendingUp,
            title: "Reportes regulatorios",
            desc: "Generación automática de reportes de cumplimiento adaptados a los requisitos de cada jurisdicción.",
          },
          {
            icon: BarChart3,
            title: "ROI medible",
            desc: "Métricas claras de retorno sobre inversión que demuestran el impacto en la reducción de pérdidas.",
          },
        ]}
      />
      ...
      <section className="py-20 bg-lockall-navy">
        <div className="container text-center">
          <SectionReveal>
            ...
            <p className="text-[16px] text-white/60 max-w-[520px] mx-auto mb-8">
              Nuestro equipo de especialistas evaluará su caso particular y le
              presentará una propuesta personalizada.
            </p>
            <Link
              href="/contacto"
              className="inline-flex items-center gap-2 h-12 px-7 text-[14px] font-heading font-semibold text-lockall-navy bg-white hover:bg-white/90 rounded transition-all duration-200"
