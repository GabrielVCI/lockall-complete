...
const resources = [
  {
    ...
    title: "LOCKALL: Soluciones de Mitigación de Riesgo",
    description:
      "Documento de alto nivel que presenta la propuesta de valor de LOCKALL, casos de uso principales y métricas de impacto para comités ejecutivos.",
    format: "PDF",
    pages: "12 páginas",
  },
  {
    ...
    title: "Arquitectura de Seguridad de 6 Capas",
    description:
      "Descripción técnica detallada de la arquitectura de seguridad integrada en las soluciones de LOCKALL, incluyendo protocolos de cifrado, mecanismos de protección y estándares de cumplimiento.",
    format: "PDF",
    pages: "28 páginas",
  },
  {
    ...
    title: "Reducción de Riesgo en Carteras de Dispositivos",
    description:
      "Estudio cuantitativo del impacto de LOCKALL en la reducción de pérdidas por impago, basado en datos agregados de instituciones clientes en múltiples mercados.",
    format: "PDF",
    pages: "18 páginas",
  },
  {
    ...
    title: "Solicitud de Presentación Privada",
    description:
      "Agende una presentación personalizada con nuestro equipo de especialistas, adaptada a las necesidades y contexto específico de su institución.",
    format: "Agenda",
    pages: "45 minutos",
  },
];
        ...
        <div className="container">
          <div className="text-center max-w-[720px] mx-auto">
            ...
            <p className="text-[17px] leading-relaxed text-lockall-graphite max-w-[600px] mx-auto">
              Documentación técnica y ejecutiva diseñada para facilitar la
              evaluación de LOCKALL por parte de equipos de riesgo, tecnología y
              dirección.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-lockall-pearl">
        <div className="container text-center">
          <SectionReveal>
            ...
            <p className="text-[16px] text-lockall-graphite max-w-[520px] mx-auto mb-8">
              Podemos preparar documentación personalizada para su proceso de
              evaluación, incluyendo análisis de caso específico para su
              mercado.
            </p>
            <Link
              href="/contacto"
